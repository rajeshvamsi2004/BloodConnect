...
className={px-6 py-3 text-lg font-semibold rounded-t-lg transition-all duration-300 ${ isLogin ? 'bg-red-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300' }}
>
Login
</button>
<button
